...
export const teams = [
  ...
  {
    value: 20,
    label: 'Our Healthy Team Dynamics allows Ownership',
  },
  {
    value: 30,
    label: 'A Productive Work Force, including production tools, space, communication, goal setting and roles',
  },
  {
    value: 40,
    label: 'We manage multiple close customer relationships',
  },
  {
    value: 50,
    label: 'The founders have a  personal relationship with the problem',
  },
  {
    value: 60,
    label: 'The Team has an aligned understanding of The customer needs & problems',
  },
  {
    value: 70,
    label: 'We understand what factors drive growth and retention',
  },
  {
    value: 80,
    label: 'We manage to attract top talent for growth',
  },
  {
    value: 90,
    label: 'We have a strategy to grow team processes and culture',
  },
  {
    value: 100,
    label: 'Managment, Product and growth team are ready for growth',
  }
];
