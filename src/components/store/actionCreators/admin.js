...
const BASE_URL = 'https://starthubafrica-api.el.r.appspot.com';
...
export const getAdminBoard = (userId) => {
	return (dispatch, getState) => {
		...
		axios
			.get(`${BASE_URL}/admin/boards/${userId}`, {
				headers: {
					ContentType: 'Application/json',
					'Access-Control-Allow-Origin': '*',
					Authorization: token
...
export const getAdminLists = (userId) => {
	return (dispatch, getState) => {
		...
		axios
			.get(`${BASE_URL}/admin/lists/${userId}`, {
				headers: {
					ContentType: 'Application/json',
					'Access-Control-Allow-Origin': '*',
					Authorization: token
...
export const getAdminStatements = (userId) => {
	return (dispatch, getState) => {
		...
		axios
			.get(`${BASE_URL}/admin/statements/${userId}`, {
				headers: {
					ContentType: 'Application/json',
					'Access-Control-Allow-Origin': '*',
					Authorization: token
...
export const addAdminObjectives = (boardId, description, quarter, startupId, callback) => {
	return (dispatch, getState) => {
		...
		axios
			.post(`${BASE_URL}/admin/objective/${boardId}`, data, {
				headers: {
					ContentType: 'Application/json',
					'Access-Control-Allow-Origin': '*',
					Authorization: token
...
export const editAdminObjective = (id, description, startupId, callback) => {
	return (dispatch, getState) => {
		...
		axios
			.put(`${BASE_URL}/admin/objective/${id}`, data, {
				headers: {
					ContentType: 'Application/json',
					'Access-Control-Allow-Origin': '*',
					Authorization: token
...
export const getAdminObjectives = (userId) => {
	return (dispatch, getState) => {
		...
		axios
			.get(`${BASE_URL}/admin/objectives/${userId}`, {
				headers: {
					ContentType: 'Application/json',
					'Access-Control-Allow-Origin': '*',
					Authorization: token
...
export const deleteAdminObjective = (id, startupId, callback) => {
	return (dispatch, getState) => {
		...
		axios
			.delete(`${BASE_URL}/admin/objective/${id}/${startupId}`, {
				headers: {
					ContentType: 'Application/json',
					'Access-Control-Allow-Origin': '*',
					Authorization: token
...
export const archiveAdminObjective = (id, startupId, callback) => {
	return (dispatch, getState) => {
		...
		axios
			.put(`${BASE_URL}/admin/archive-obj/${id}`, data, {
				headers: {
					ContentType: 'Application/json',
					'Access-Control-Allow-Origin': '*',
					Authorization: token
...
export const addAdminkeyResult = (description, measureOfSuccess, objId, startupId, controller, callback) => {
	return (dispatch, getState) => {
		...
		axios
			.post(`${BASE_URL}/admin/keyresult`, data, {
...
export const editAdminkeyResult = (description, measureOfSuccess, dateCreated, objId, startupId, callback) => {
	return (dispatch, getState) => {
		...
		axios
			.put(`${BASE_URL}/admin/keyresult`, data, {
				headers: {
					ContentType: 'Application/json',
					'Access-Control-Allow-Origin': '*',
					Authorization: token
...
export const deleteAdminKeyResult = (objId, krId, startupId, callback) => {
	return (dispatch, getState) => {
		...
		axios
			.delete(`${BASE_URL}/admin/keyresult/${objId}/${krId}/${startupId}`, {
				headers: {
					ContentType: 'Application/json',
					'Access-Control-Allow-Origin': '*',
					Authorization: token
...
export const getAdminValues = (userId) => {
	return (dispatch, getState) => {
		...
		axios
			.get(`${BASE_URL}/admin/values/${userId}`, {
				headers: {
					ContentType: 'Application/json',
					'Access-Control-Allow-Origin': '*',
					Authorization: token
...
export const getAdminCards = (userId, boardId) => {
	return (dispatch, getState) => {
		...
		axios
			.get(`${BASE_URL}/admin/cards/${userId}/${boardId}`, {
				headers: {
					ContentType: 'Application/json',
					'Access-Control-Allow-Origin': '*',
					Authorization: token
...
export const archiveAdminBoard = (id, userId, callback) => {
	return (dispatch, getState) => {
		...
		axios
			.put(`${BASE_URL}/admin-board/archive/${id}`, data, {
				headers: {
					ContentType: 'Application/json',
					'Access-Control-Allow-Origin': '*',
					Authorization: token
...
export const unarchiveAdminBoard = (id, userId, callback) => {
	return (dispatch, getState) => {
		...
		axios
			.put(`${BASE_URL}/admin-board/restore-board/${id}`, data, {
				headers: {
					ContentType: 'Application/json',
					'Access-Control-Allow-Origin': '*',
					Authorization: token
...
export const archiveAdminList = (id, userId, boardId, callback) => {
	return (dispatch, getState) => {
		...
		axios
			.put(`${BASE_URL}/admin-list/archive/${id}`, data, {
				headers: {
					ContentType: 'Application/json',
					'Access-Control-Allow-Origin': '*',
					Authorization: token
...
export const unarchiveAdminList = (id, userId, boardId, callback) => {
	return (dispatch, getState) => {
		...
		axios
			.put(`${BASE_URL}/admin-list/restore-list/${id}`, data, {
				headers: {
					ContentType: 'Application/json',
					'Access-Control-Allow-Origin': '*',
					Authorization: token
...
export const addFlate = (
	...
	return (dispatch, getState) => {
		...
		axios
			.post(`${BASE_URL}/admin/flatrate`, data, {
				headers: {
					ContentType: 'Application/json',
					'Access-Control-Allow-Origin': '*',
					Authorization: token
...
export const addFlateratePayment = (loanId, amount, callback) => {
	return (dispatch, getState) => {
		...
		axios
			.post(`${BASE_URL}/admin/fr-payment/${loanId}`, data, {
				headers: {
					ContentType: 'Application/json',
					'Access-Control-Allow-Origin': '*',
					Authorization: token
...
export const searchFlatrate = (startup, callback) => {
	return (dispatch, getState) => {
		...
		axios
			.get(`${BASE_URL}/admin/shorterm-loan?startup=${startup}`, {
				headers: {
					ContentType: 'Application/json',
					'Access-Control-Allow-Origin': '*',
					Authorization: token
...
export const addReducingBalance = (amount, date, duration, startup, comment, interestRate, grace_period, loanType) => {
	return (dispatch, getState) => {
		...
		axios
			.post(`${BASE_URL}/admin/reducing-balance`, data, {
				headers: {
					ContentType: 'Application/json',
					'Access-Control-Allow-Origin': '*',
					Authorization: token
...
export const addRBPayment = (loanId, installAmount, callback) => {
	return (dispatch, getState) => {
		...
		axios
			.post(`${BASE_URL}/admin/rb-payment/${loanId}`, data, {
				headers: {
					ContentType: 'Application/json',
					'Access-Control-Allow-Origin': '*',
					Authorization: token
...
export const searchReducingBalance = (startup, callback) => {
	return (dispatch, getState) => {
		...
		axios
			.get(`${BASE_URL}/admin/longterm-loan?startup=${startup}`, {
				headers: {
					ContentType: 'Application/json',
					'Access-Control-Allow-Origin': '*',
					Authorization: token
...
export const getReducingBalance = () => {
	return (dispatch, getState) => {
		...
		axios
			.get(`${BASE_URL}/admin/reducing-balance`, {
				headers: {
					ContentType: 'Application/json',
					'Access-Control-Allow-Origin': '*',
					Authorization: token
...
export const addRevenueShare = (
	...
	return (dispatch, getState) => {
		...
		axios
			.post(`${BASE_URL}/admin/revenue-share`, data, {
				headers: {
					ContentType: 'Application/json',
					'Access-Control-Allow-Origin': '*',
					Authorization: token
...
export const getRevenueShares = () => {
	return (dispatch, getState) => {
		...
		axios
			.get(`${BASE_URL}/admin/revenue-shares`, {
				headers: {
					ContentType: 'Application/json',
					'Access-Control-Allow-Origin': '*',
					Authorization: token
...
export const approvePayment = (id, callback) => {
	return (dispatch, getState) => {
		...
		axios
			.put(`${BASE_URL}/admin/approve/${id}`, data, {
				headers: {
					ContentType: 'Application/json',
					'Access-Control-Allow-Origin': '*',
					Authorization: token
...
export const searchRevShare = (startup) => {
	return (dispatch, getState) => {
		...
		axios
			.get(`${BASE_URL}/admin/revenue-share?startup=${startup}`, {
				headers: {
					ContentType: 'Application/json',
					'Access-Control-Allow-Origin': '*',
					Authorization: token
...
export const addAuthor = (name, imageLink, bio, callback) => {
	return (dispatch, getState) => {
		...
		axios
			.post(`${BASE_URL}/admin/author`, data, {
				headers: {
					ContentType: 'Application/json',
					'Access-Control-Allow-Origin': '*',
					Authorization: token
...
export const addRevenue = (startup, month_revenue, month_expense, date, month) => {
	return (dispatch, getState) => {
		...
		axios
			.post(`${BASE_URL}/admin/revenue`, data, {
				headers: {
					ContentType: 'Application/json',
					'Access-Control-Allow-Origin': '*',
					Authorization: token
...
export const getStartupRevenueTracking = (creator, year, callback) => {
	return (dispatch, getState) => {
		...
		axios
			.post(`${BASE_URL}/admin/startup-revenue`, data, {
				headers: {
					ContentType: 'Application/json',
					'Access-Control-Allow-Origin': '*',
					Authorization: token
...
export const searchRevenueTracking = (year) => {
	return (dispatch, getState) => {
		...
		axios
			.get(`${BASE_URL}/admin/rev-tracking/search?year=${year}`, {
				headers: {
					ContentType: 'Application/json',
					'Access-Control-Allow-Origin': '*',
					Authorization: token
...
export const getRevenueTracking = () => {
	return (dispatch, getState) => {
		...
		axios
			.get(`${BASE_URL}/admin/rev-tracking`, {
				headers: {
					ContentType: 'Application/json',
					'Access-Control-Allow-Origin': '*',
					Authorization: token
...
export const getRevenueAccumulation = () => {
	return (dispatch, getState) => {
		...
		axios
			.get(`${BASE_URL}/admin/rev-accumulation`, {
				headers: {
					ContentType: 'Application/json',
					'Access-Control-Allow-Origin': '*',
					Authorization: token
...
export const sendEmail = (email, startup, months, callback) => {
	return (dispatch) => {
		...
		axios
			.post(`${BASE_URL}/admin/previous-month-email`, data, {
				contentType: 'application/json'
			})
			.then((res) => {
				console.log(res.data);
