	...
	return (
		<div className="sidebar-overlay">
			<div className="sidebar-container">
				...
				{admin ? (
					<Menu style={{ width: '100%', background: 'none', marginTop: '1rem' }}>
						<div className="links-row">
							<h5 onClick={handleStartupNavigation}>Startups</h5>
						</div>
						<div className="links-row" onClick={handleRegisterNavigation}>
							<h5>Register Startups</h5>
						</div>
					</Menu>
				) : (
					<Menu style={{ width: '100%', background: 'none', marginTop: '1rem' }}>
						<div className="links-row">
							<h5 onClick={handleCarlenderNavigation}>Schedule Meeting</h5>
						</div>
						<div className="links-row" onClick={handleDashboardNavigation}>
							<h5>Dashboard</h5>
						</div>
						<div className="links-row">
							<h5 onClick={handleTodosNavigation}>Todos</h5>
						</div>
						<div className="links-row">
							<h5 onClick={handleCanvasNavigation}>Lean Canvas</h5>
						</div>
						<div className="links-row">
							<h5 onClick={handleMilestonesNavigation}>Milestones</h5>
						</div>
					</Menu>
				)}
				{admin ? null : (
					<a href={link} target="blank">
						<button className="report-sidebar">Report</button>
					</a>
				)}
